-- Fix: tarefas avulsas geradas para projetos concluídos não devem herdar as
-- classificações da categoria "Implantação" (causavam erro de validação do
-- trigger validate_tarefa_classificacao). Avulsas nascem sem classificação.
